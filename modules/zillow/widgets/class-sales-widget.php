...
class ZillowPastSalesWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<iframe id="" class="" scrolling="no" src="https://www.zillow.com/widgets/profile/PastSalesListingWidget.htm?aid='. $zuid .'&newVersion=true&widgetFormat='. $format .'" width="500" height="250" frameborder="0" style="display:block;width:100%;max-width:100%;"></iframe>';
