...
class ZillowMortgageCalcWidget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<iframe id="" class="" scrolling="no" title="Mortgage Calculators on Zillow" src="https://www.zillow.com/mortgage/SmallMortgageLoanCalculatorWidget.htm?widgetOrientationType='. $orientation .'" width="'. $width .'" height="'. $height .'" frameborder="0" style="display:block;width:100%;max-width:100%;"></iframe>';
